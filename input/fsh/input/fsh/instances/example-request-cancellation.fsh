...
* extension[SenaiteClient].valueReference.reference = "Organization/6c248ba7-a4c4-4606-b4a0-efbff71fb902"
...
//
// Returned when the ServiceRequest cannot be revoked because
// results have already been published in SENAITE.
// ================================================================
